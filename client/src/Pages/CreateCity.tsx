...
const CreateCity = () => {
  const { cityFormValues, handleChange, handleImageChange, handleSubmit } =
    useCreateCity();
  return (
    <form
    ...
    >
      ...
      <div className="flex flex-col mb-5 w-full max-w-md">
        ...
        />
        {cityFormValues.thumbnail ? (
          <div className="mt-2 flex justify-center">
            <img
              src={cityFormValues.thumbnail}
              alt="Thumbnail"
      ...
      <div className="flex flex-col mb-5 w-full max-w-md">
        ...
        <textarea
          ...
          value={cityFormValues.description}
          onChange={handleChange}
          className="border-2 border-gray-300 rounded-md p-3 text-sm w-full"
        />
      </div>
